      ...
      <div className="flex flex-col items-center justify-center w-full selection:bg-[#B3D4FC]">
        <div className="flex flex-col w-[75%] h-full gap-6">
          ...
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center justify-center rounded-md bg-[#e7e8ea] ">
              {
            ...
            <div className={`inline-flex w-18 items-center justify-between rounded-2xl  p-0.75  gap-2 cursor-pointer ${dateStatus ? " bg-[#BC0C19]" : "bg-[#A0A4A8]"}`}>
          ...
          <div className="grid grid-cols-9  gap-6 mb-30">
            {
              [...campaignsData]
                .sort((a, b) =>
                ...
                .map((item, id) => (
                  <div key={id} className="col-span-3 row-span-2 p-4 bg-[#F9F9FA] overflow-hidden flex flex-col gap-3  justify-between cursor-pointer">
                    <img src={item.attributes.image.data.attributes.url} className='w-full object-cover' />
