      ...
      <>
        <div className="flex flex-col items-center justify-center w-full selection:bg-[#B3D4FC] mb-20">
          <div className="flex flex-col w-[95%] sm:w-[75%] md:w-[95%] lg:w-[75%] h-full">
            ...
            <div className="flex flex-col justify-between w-full bg-[linear-gradient(98.65deg,rgb(236,50,66)_0%,rgb(153,0,0)_100%)] rounded-xl relative overflow-hidden h-full  sm:flex-col lg:flex-row">
              ...
              <div className="flex items-center justify-end  w-full sm:w-full sm:justify-end lg:w-[50%] lg:py-12 lg:px-2.5 lg:justify-center ">
                <img src="https://birbank.az/file/avto_credit_7b67f1429b.svg" className='w-110 object-contain flex  bottom-0 right-10 h-full self-end sm:self-end lg:self-center lg:absolute' alt="BirPay" />
              </div>
            </div>
            <div className="flex flex-col  w-full">
              <h2 className='text-[30px] text-[rgb(34,34,34)] font-semibold my-10'>Avtomobil kalkulyator</h2>
              <div className="flex flex-col items-start justify-between rounded-xl bg-[#F9F9FA] w-full gap-4 p-10 h-full sm:flex-col md:flex-row">
                <div className="flex flex-col gap-9 w-full sm:w-full  md:w-[40%] h-full">
                  ...
                  <div className="flex flex-col  rounded-t-[10px] rounded-b-[5px] bg-white border border-[#e5e5e9]">
                    ...
                    <input type="range" min={10} max={100} value={ilkinOdenis} className='w-full bg-[rgb(231, 232, 234)] h-px -mt-0.5' onChange={(e) => setIlkinOdenis(e.target.value)} />
                  </div>
                  ...
                  <div className="flex flex-col  rounded-t-[10px] rounded-b-[5px] bg-white border border-[#e5e5e9]">
                    ...
                    <input type="range" min={0} max={500000} value={carPrice} className='w-full bg-[rgb(231, 232, 234)] h-px -mt-0.5' onChange={(e) => { setCarPrice(e.target.value); }} />
                  </div>
                  ...
                  <div className="flex flex-col  rounded-t-[10px] rounded-b-[5px] bg-white border border-[#e5e5e9]">
                    ...
                    <input type="range" min={12} max={59} value={creditTime} className='w-full bg-[rgb(231, 232, 234)] h-px -mt-0.5' onChange={(e) => setCreditTime(e.target.value)} />
                  </div>
                ...
                <div className="flex flex-col items-center justify-center rounded-xl bg-white py-6 px-10 w-full sm:w-full md:w-[50%] h-full">
          ...
          <div className="flex flex-col gap-5 items-center justify-center w-full my-15 bg-[#F9F9FA] py-6">
            ...
            <div className="flex flex-col w-[95%] sm:w-[75%] md:-[95%] lg:w-[75%] items-center justify-center gap-1 my-3">
              {
