    ...
    <>
      <div className="flex items-center justify-center w-full selection:bg-[#B3D4FC]">
        <div className="grid grid-cols-2 grid-rows-6 gap-6 w-[75%]">
          <Link to='/kreditler' className="row-span-3 rounded-[12px] pl-[40px] pt-[24px] pb-[24px] pr-0 bg-[#FDF0F1] w-full relative" reloadDocument>
            <div className="flex  items-center justify-between ">
              <div className="flex flex-col w-[50%] gap-10">
                ...
                <Link to='/kreditler' className='flex items-center  py-[12px] rounded-[10px] gap-1' reloadDocument>
          ...
          <Link className="row-span-3 col-start-1 row-start-4 rounded-[12px] pl-[40px] pt-[24px] pb-[24px] pr-0 bg-[#F3F3F5] w-full relative">
            <div className="flex  items-center justify-between ">
              <div className="flex flex-col w-[50%] gap-10">
                <div className="flex flex-col w-full gap-1">
