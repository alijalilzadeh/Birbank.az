    ...
    <>
      <div className="flex flex-col items-center justify-center w-full selection:bg-[#B3D4FC]">
        <div className="flex flex-col w-[95%] sm:w-[75%] md:w-[95%] lg:w-[75%]">
          ...
          <div className="flex flex-col justify-between w-full bg-[linear-gradient(98.65deg,rgb(236,50,66)_0%,rgb(153,0,0)_100%)] rounded-[10px] relative overflow-hidden sm:flex-col lg:flex-row">
            <div className="flex flex-col w-full gap-4 px-4 pb-0 pt-12 sm:pb-0 sm:px-4 sm:pt-12 sm:w-full md:pb-0 lg:py-12 lg:px-18 lg:w-[70%]">
            ...
            <div className="flex w-full mt-10 justify-end sm:justify-end sm:mt-10  lg:py-12 lg:px-2.5 lg:m-0 sm:w-full lg:items-center lg:justify-center lg:w-[50%]">
              <img src={BirPay} className='w-103.5 object-cover  self-end  bottom-0 right-10 h-full lg:absolute' alt="BirPay" />
            </div>
          </div>
          <div className="flex flex-col gap-4 ">
            <h2 className='mt-12 mb-7.5 text-[30px] font-semibold text-[#222222]'>Əsas nəticələrimiz!</h2>
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center w-full  py-14 px-6 bg-[#25282B] rounded-2xl flex-wrap sm:flex-wrap lg:flex-nowrap">
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <h2 className='mt-12 mb-7.5 text-[30px] font-semibold text-[#222222] self-start text-start'>Brendlərimiz</h2>

            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2  gap-6 justify-items-center w-full sm:w-full md:w-[80%] lg:w-full">
              <div className="flex flex-col  gap-2 bg-[#F3F3F5] rounded-[10px] w-full relative overflow-hidden h-full sm:flex-row md:flex-row lg:flex-row">
                <div className="flex flex-col gap-1 w-full sm:w-[60%] p-6 pl-6 pr-4">
                  <p className='text-[20px] text-[#25282b] font-semibold sm:text-[20px] lg:text-[32px]'>Birbank</p>
                ...
                <img src={BirBankMainScreen} className='object-contain max-w-50 w-full bottom-0 right-0 lg:absolute h-90 pt-6 self-center sm:self-end lg:self-end' alt="Birbank Main Screen" />
              </div>

              <div className="flex flex-col bg-[#F3F3F5] rounded-[10px] w-full relative overflow-hidden cursor-pointer h-full sm:flex-row lg:flex-row">
                <div className="flex flex-col gap-1 w-full sm:w-[60%] p-6 pl-6 pr-4 ">
                  <p className='text-[20px] text-[#25282b] font-semibold sm:text-[20px] lg:text-[32px]'>Birbank Biznes</p>
                ...
                <img src={BirBankBiznes} className='lg:absolute max-w-50 w-full bottom-0 right-0 h-90 pt-6 self-center sm:self-end lg:self-end' alt="Birbank Biznes" />
              </div>

              <div className="flex flex-col bg-[#F3F3F5] rounded-[10px] w-full relative overflow-hidden cursor-pointer h-full sm:flex-row lg:flex-row">
                <div className="flex flex-col gap-1w-full sm:w-[60%] p-6 pl-6 pr-4 ">
                  <p className='text-[20px] text-[#25282b] font-semibold sm:text-[20px] lg:text-[32px]'>Birbank Invest</p>
                ...
                <img src={BirBankInvest} className='lg:absolute max-w-50 w-full bottom-0 right-0 h-90 pt-6 self-center sm:self-end lg:self-end' alt="Birbank Invest" />
              </div>
              <div className="flex flex-col bg-[#F3F3F5] rounded-[10px] w-full relative overflow-hidden cursor-pointer h-full sm:flex-row lg:flex-row">
                <div className="flex flex-col gap-1 w-full sm:w-[60%] p-6 pl-6 pr-4 ">
                  <p className='text-[20px] text-[#25282b] font-semibold sm:text-[20px] lg:text-[32px]'>Birmarket</p>
                ...
                <img src={BirMarket} className='lg:absolute max-w-50 w-full bottom-0 right-0 h-90 pt-6 self-center sm:self-end lg:self-end' alt="Birmarket" />
              </div>
              <div className="flex  flex-col  bg-[#F3F3F5] rounded-[10px] w-full relative overflow-hidden cursor-pointer h-full sm:flex-row lg:flex-row lg:col-start-1">
                <div className="flex flex-col gap-1 w-full sm:w-[60%] p-6 pl-6 pr-4 ">
                  <p className='text-[20px] text-[#25282b] font-semibold sm:text-[20px] lg:text-[32px]'>m10</p>
                ...
                <img src={M10} className=' lg:absolute max-w-50 w-full bottom-0 right-0 h-90 pt-6 self-center sm:self-end lg:self-end' alt="Birmarket" />
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <h2 className='mt-12 mb-7.5 text-[30px] font-semibold text-[#222222] text-start self-start'>Birgə layihələrimiz</h2>
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 w-[80%] sm:w-[90%] md:w-[95%] lg:w-full gap-6 h-full">
              <div className="flex flex-col items-center justify-between  w-full bg-[#FDF0F1] rounded-[10px] relative h-full sm:flex-row md:flex-row lg:flex-row">
                <div className="flex flex-col pl-6 py-6 pr-4 w-full sm:w-full lg:w-[60%]">
                  <h2 className='text-[#25282b] text-[20px] font-semibold sm:text-[20px] lg:text-[32px] '>Trendyol</h2>
                  <p className='text-[#212426] text-[14px] font-normal mt-2'>Birgə əməkdaşlığımız nəticəsində ölkəmizin hər yanına birbaşa çatdırılma həyata keçirən dünyanın ən böyük e-ticarət platformalarından biri</p>
                ...
                <img src={Trendyol} className='object-contain  lg:absolute bottom-0 right-0  ' />
              </div>
              <div className="flex flex-col items-center justify-between col-span-3 row-span-6 w-full bg-[#FDF0F1] rounded-[10px] relative h-full sm:flex-row md:flex-row lg:flex-row">
                <div className="flex flex-col pl-6 py-6 pr-4 w-full sm:w-full lg:w-[60%]">
                  <h2 className='text-[#25282b] text-[20px] font-semibold sm:text-[20px] lg:text-[32px] '>BakıKart</h2>
                  <p className='text-[#212426] text-[14px] font-normal mt-2'>Metro və avtobus kimi əsas ictimai nəqliyyat vasitələri üçün nağdsız ödəniş üsulu.</p>
                  <ul className='font-semibold pl-4 text-[#212426] text-[16px] gap-1 list-disc leading-5'>
                ...
                <img src={BakiKart} className='object-contain  lg:absolute bottom-0 right-0 ' />
              </div>
            </div>
          </div>

          <div className="flex flex-col gap-4 w-full items-center justify-center">
            <h2 className='mt-12 mb-7.5 text-[30px] font-semibold text-start self-start  text-[#222222]'>Məhsullarımız</h2>

            <div className="grid grid-cols-1 sm:grid-cols-1  lg:grid-cols-3  gap-4 justify-items-center w-[70%] sm:w-[60%] md:w-[50%] lg:w-full  h-full">
              <div className=" flex flex-col justify-between relative w-full  h-full border border-[#F3F3F5] rounded-xl cursor-pointer transition duration-450 hover:shadow-[-2px_2px_17px_0px_rgba(0,0,0,0.1)]">
                <div className="flex flex-col gap-2 px-4 py-6  h-full">
                  <h2 className='text-[#25282b] text-[20px] sm:text-[20px] lg:text-[32px] font-semibold'>Bir Bonus</h2>
                ...
                <div className="flex items-center justify-center">
                  <img src={BirBonus} className='object-contain  items-center justify-center w-78' />
                </div>
              </div>
              <div className=" flex flex-col justify-between relative w-full  h-full border border-[#F3F3F5] rounded-xl cursor-pointer transition duration-450 hover:shadow-[-2px_2px_17px_0px_rgba(0,0,0,0.1)]">
                <div className="flex flex-col gap-2 px-4 py-6">
                  <h2 className='text-[#25282b] sm:text-[20px] lg:text-[32px] font-semibold'>Bir ID</h2>
                  <p className='text-[#212426] text-[14px] font-normal'>Ekosistem daxilindəki bütün xidmətlər üçün vahid giriş üsulu</p>
                </div>
                <div className="flex items-center justify-center">
                  <img src={BirID} className='object-contain  items-center justify-center w-78' />
                </div>
              </div>
              <div className=" flex flex-col justify-between relative w-full h-full border border-[#F3F3F5] rounded-xl cursor-pointer transition duration-450 hover:shadow-[-2px_2px_17px_0px_rgba(0,0,0,0.1)]">
                <div className="flex flex-col gap-2 px-4 py-6">
                  <h2 className='text-[#25282b] sm:text-[20px] lg:text-[32px] font-semibold'>Bir Pay</h2>
                ...
                <div className="flex items-center justify-center">
                  <img src={BirPaySVG} className='object-contain  items-center justify-center w-78' />
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center w-full justify-center my-20 h-full">
            <div className="flex flex-col gap-5 w-full rounded-2xl items-center justify-center p-10 bg-[#25282B] h-full">
              ...
              <p className='text-white text-[14px] sm:text-[20px] lg:text-[20px] font-normal'>Maliyyə göstəriciləri, strateji tərəfdaşlıqlar və ya investisiya imkanları üçün əlaqə saxla.</p>
