  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center w-full my-15  selection:bg-[#B3D4FC]">
        <div className="flex flex-col   w-full sm:w-[75%] md:w-[95%] md:gap-5 lg:w-[75%] lg:gap-10">
          ...
          <div className="grid grid-cols-6 items-center justify-center w-full h-full gap-4">
            {newsData?.pageProps?.initialState?.news?.newsData?.slice(0, 3).map((item) => (
              <Link key={item.id} className="relative col-span-6 sm:col-span-3 md:col-span-3 lg:col-span-2 gap-3 border-b w-full h-full border-[#F3F3F5] rounded-[10px]  p-3">
                <img
