                ...
                <div className="inline-flex flex-col  text-start  gap-3 w-fit pb-10">
                  {dropdown === 'Kreditler' ? (
                    ...
                    <>
                      ...
                      <Link to='/yigim-hesabi' className='text-[14px] text-[#9496ac] font-medium'>Yığım hesabı</Link>
                      <Link  className='text-[14px] text-[#9496ac] font-medium' reloadDocument>Müddətsiz depozit</Link>
                      <Link to='/avans' className='text-[14px] text-[#9496ac] font-medium' reloadDocument>Depozit seyfləri</Link>
                    </>
                  )
                  }
                </div>
