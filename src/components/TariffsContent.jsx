...
<Link className='text-[14px] p-3.75 text-[#6D7478]' to="/" reloadDocument>Ana Səhifə</Link>              <Link className=' text-[#25282b] text-[14px] p-3.75 pl-0' to="/ninja">Tariflər</Link>
          ...
          <div className="flex justify-between w-full bg-[linear-gradient(98.65deg,rgb(236,50,66)_0%,rgb(153,0,0)_100%)] rounded-xl relative overflow-hidden h-full py-16">
            ...
            <div className="flex items-center justify-center w-[50%] py-12 px-2.5 ">
              <img src={TarifBanner} className='w-auto object-contain flex absolute bottom-0 right-10 h-full' alt="BirPay" />
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center justify-center gap-10 w-full my-20 ">
          ...
          <div className="grid grid-cols-6 gap-7 w-[75%] items-center justify-center">
            {tariffStatus === "tarif" ?
              (
                <>
                  <Link to='https://birbank.az/file/download_194_2246487a7c.xlsx' className="col-span-3 row-span-2 flex items-center justify-between p-6 rounded-xl bg-[#F3F3F5] w-full">
                  ...
                  <Link to='https://birbank.az/file/download_197_5079ed4923.xlsx' className="col-span-3 row-span-2 flex items-center justify-between p-6 rounded-xl bg-[#F3F3F5] w-full">
                    <p className='text-[16px] text-[#252525] font-medium'>Birbank mobil tətbiqi üzrə tariflər</p>
                    <LiaFileDownloadSolid className='text-[#EC3342] text-[28px]' />
                  </Link>

                  <Link to='https://birbank.az/file/download_209_9370f0eb93.xlsx' className="col-span-3 row-span-2 flex items-center justify-between p-6 rounded-xl bg-[#F3F3F5] w-full">
                    <p className='text-[16px] text-[#252525] font-medium'>Ödəniş kartları üzrə tariflər</p>
                    <LiaFileDownloadSolid className='text-[#EC3342] text-[28px]' />
                  </Link>

                  <Link to='https://birbank.az/file/elave_sertler_8d1790783e.pdf' className="col-span-3 row-span-2 flex items-center justify-between p-6 rounded-xl bg-[#F3F3F5] w-full" reloadDocument>
                    <p className='text-[16px] text-[#252525] font-medium'>Kartdan tutulan vergilər</p>
                    <LiaFileDownloadSolid className='text-[#EC3342] text-[28px]' />
                  </Link>

                  <Link to='https://birbank.az/file/Hueququ_s_xsl_r_v_f_rdi_sahibkarlar_uezr_tarifl_r_az_49d56b4fe3.pdf' className="col-span-3 row-span-2 flex items-center justify-between p-6 rounded-xl bg-[#F3F3F5] w-full" reloadDocument>
                    <p className='text-[16px] text-[#252525] font-medium'>Hüquqi şəxslər və fərdi sahibkarlar üzrə tariflər</p>
                    <LiaFileDownloadSolid className='text-[#EC3342] text-[28px]' />
                  </Link>

                  <Link to='https://birbank.az/file/Microsoft_Word_standart_sertler_TC_11_noyabr_2016_a50e42a99f.pdf' className="col-span-3 row-span-2 flex items-center justify-between p-6 rounded-xl bg-[#F3F3F5] w-full" reloadDocument>
